...
/// Color palette for a theme. Not every slot is consumed by the current UI;
/// the full palette is kept intentional so new widgets can pick from it.
#[allow(dead_code)]
#[derive(Debug, Clone)]
...
impl Theme {
    ...
    fn default_colors() -> ThemeColors {
        ThemeColors {
            // Near-black canvas, quiet borders, one electric accent —
            // a minimal, technical look for the default theme.
            primary: Color::Rgb(0x81, 0x8C, 0xF8), // soft indigo
            secondary: Color::Rgb(0x22, 0xD3, 0xEE), // cyan
            accent: Color::Rgb(0x22, 0xD3, 0xEE),  // cyan

            success: Color::Rgb(0x34, 0xD3, 0x99), // emerald
            warning: Color::Rgb(0xFB, 0xBF, 0x24), // amber
            error: Color::Rgb(0xF8, 0x71, 0x71),   // red
            info: Color::Rgb(0x60, 0xA5, 0xFA),    // blue

            bg_dark: Color::Rgb(0x0B, 0x0B, 0x0F), // near black
            bg_card: Color::Rgb(0x14, 0x14, 0x1A), // raised surface
            bg_elevated: Color::Rgb(0x1B, 0x1B, 0x22), // panel
            bg_highlight: Color::Rgb(0x23, 0x23, 0x2C), // selection

            text: Color::Rgb(0xE7, 0xE7, 0xEC),
            text_muted: Color::Rgb(0x8D, 0x8D, 0x99),
            text_dim: Color::Rgb(0x4A, 0x4A, 0x55), // doubles as hairline color

            rating_again: Color::Rgb(0xF8, 0x71, 0x71), // red
            rating_hard: Color::Rgb(0xFB, 0xBF, 0x24),  // amber
            rating_good: Color::Rgb(0x60, 0xA5, 0xFA),  // blue
            rating_easy: Color::Rgb(0x34, 0xD3, 0x99),  // emerald
        }
    }
